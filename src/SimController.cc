...
short int MyConfig::bitLenOfHdr 			= 1; //80;
short int MyConfig::bitLenOfDcId 			= 1; //12;
short int MyConfig::bitLenOfChainId 	= 1; //14; 
short int MyConfig::bitLenOfClassId 	= 1; //4;
short int MyConfig::bitLenOfCpuAlloc	= 1; //5;
short int MyConfig::bitLenOfDefCpu 		= 1; //16;
