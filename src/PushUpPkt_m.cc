...
void PushUpPkt::setPushUpVecArraySize(unsigned int size)
{
...
unsigned int PushUpPkt::getPushUpVecArraySize() const
{
    return pushUpVec_arraysize;
}

ChainIdAndLvl& PushUpPkt::getPushUpVec(unsigned int k)
{
...
void PushUpPkt::setPushUpVec(unsigned int k, const ChainIdAndLvl& pushUpVec)
{
    if (k>=pushUpVec_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", pushUpVec_arraysize, k);
...
int PushUpPktDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "pushUpVec")==0) return base+0;
...
int PushUpPktDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return pp->getPushUpVecArraySize();
        default: return 0;
    }
}
...
std::string PushUpPktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    PushUpPkt *pp = (PushUpPkt *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getPushUpVec(i); return out.str();}
        default: return "";
    }
}
...
const char *PushUpPktDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(ChainIdAndLvl));
        default: return nullptr;
    };
}
...
void *PushUpPktDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    PushUpPkt *pp = (PushUpPkt *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getPushUpVec(i)); break;
        default: return nullptr;
    }
}
